        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-5">
            <ul class="list-group margin-bottom-25 sidebar-menu">            
              <li class="list-group-item clearfix"><a href="ProductsCat1.jsp"><i class="fa fa-angle-right"></i> Formal Shirt Category1</a></li>
              <li class="list-group-item clearfix"><a href="ProductsCat2.jsp"><i class="fa fa-angle-right"></i> Formal Shirt Category2</a></li>
              <li class="list-group-item clearfix"><a href="ProductsCat3.jsp"><i class="fa fa-angle-right"></i> Formal Shirt Category3</a></li>
            </ul>
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <% {				 
					...
					try {
						stmt = con.prepareStatement("select * from products order by productid desc");							
